...
import pandas as pd
from strokes_classification import HumanPoseExtractor
...
def main():
    ...
    for ball_shot_ind in range(len(ball_shot_frames)-1):
        ...
        #speed of the ball shot in km/hr
    ...
    for frame in video_frames:
        ...
        modified_frame = human_pose_extractor.draw_results_frame(frame)
        human_pose_extractor.roi.update(human_pose_extractor.keypoints_pixels_frame)
        output_video_frames.append(modified_frame)



    output_video_frames = player_tracker.draw_bboxes(video_frames, player_detections)
    output_video_frames = ball_tracker.draw_bboxes(video_frames,ball_detections)
    output_video_frames = court_line_detector.draw_keypoints_on_video(video_frames,
                                                                      court_keypoints
                                                                      )
